...
def run(algorithm, data, max_bitmaps, max_leafs_per_bitmap, perc_redundancy_per_bitmap, leafs_to_rules_count_map,
    ...
    if algorithm == 'naive':
        naive.run(data, max_bitmaps, leafs_to_rules_count_map, max_rules_per_leaf)
        ...
        greedy_match.run(data, max_bitmaps, max_leafs_per_bitmap, perc_redundancy_per_bitmap, leafs_to_rules_count_map,
                         max_rules_per_leaf)
